  ...
  <div class="row-fluid">
      <div class="col-lg-12">
            <div class="alert alert-danger alert-dismissable">
             ...
             <i class="icon-remove"></i><strong> Cetak Laporan Barang Keluar / Terpakai</strong>
            </div>
       </div>
    </div>
  </div>
...
<p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
text-align:center;line-height:normal'><b><span style='font-size:14.0pt;
font-family:"Times New Roman","serif"'>Laporan Barang Terpakai</span></b></p>
...
"Times New Roman","serif"'>Jumlah Kerusakan Barang:<o:p></o:p></span></p>
...
<div class="pull-right">
   <div class="empty">
		   ...
		   <script type="text/javascript">
            ...
            normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
           "Times New Roman","serif"'>
			<a id="return" data-placement="top" class="btn btn-success" title="Click to Return" href="damage.php"><i class="icon-arrow-left"></i> Kembali</a></p>		
			<script type="text/javascript">
			$(document).ready(function(){
			$('#return').tooltip('show');
			$('#return').tooltip('hide');
...
<?php
		$device_query = mysql_query("select * from stdevice			
							 ...
							 where dev_status = 'terpakai' ORDER BY location_details.ld_id DESC")or die(mysql_error());
...
<?php	
	             $count_item=mysql_query("select * from stdevice 
				 LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
				 where dev_status = 'terpakai' OR dev_status = 'Terpakai' ORDER BY stdevice.id DESC ");
	             $count = mysql_num_rows($count_item);
 ?>	 
...
<hr>
		<footer>
           <p>Putri Irmawati Sukma 14401323 Komputerisasi Akuntansi Copyright 2018</p>
        <footer>
</center>
</div>
</html>