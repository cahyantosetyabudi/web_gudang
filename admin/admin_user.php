			    ...
			    <div class="empty">
                    <div class="alert alert-success alert-dismissable">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                         <i class="icon-info-sign"></i>  <strong>Peringatan!:</strong> Centang Dahulu jika ingin hapus?
                    </div>
               </div>	
                 ...
                 ?>	 
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"></i><i class="icon-user"></i> Daftar User</div>
								<div class="muted pull-right">
								Jumlah Pengguna User: <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                            </div>
