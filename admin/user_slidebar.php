	              ...
	              <img id="admin_avatar" class="img-polaroid" src="<?php echo $row['adminthumbnails']; ?>">
				   <?php include('count.php'); ?>
                    ...
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						...
						<li class="">						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs"><i class="icon-chevron-right"></i><i class="icon-tablet icon-large"></i>&nbsp;Mengelola barang
						    ...
						    <li>
                            <a href="damage.php"><i class="icon-chevron-right"></i><i class="icon-laptop"></i> Barang Keluar / terpakai
							<?php if($not_read1 == '0'){
				            }else{ ?>
							...
							<li>
                            <a href="dump_device.php"><i class="icon-chevron-right"></i><i class="icon-remove-sign"></i> Barang Keluar / Retur
					    ...
					    <li>						
						    ...
						    <li class="">
                            <a href="location.php"><i class="icon-chevron-right"></i><i class="icon-sitemap"></i> Tambah Barang</a>
                            </li>
						    </ul>
						</li>
					  ...
					  <!------/.* manage TRIS user sidebar*------->	
						<li class="active">						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs2"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;Mengelola Pengguna
							<div class="muted pull-right"><i class="caret"></i></div></a>						
