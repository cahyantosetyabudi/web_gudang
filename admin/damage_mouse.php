                 ...
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-remove-sign"></i> Daftar Kerusakan Bolpoin/Pensil</div>
                          <div class="muted pull-right">
								Jumlah Barang <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
						  </div>
						  
				<h4 id="sc">Daftar Kerusakan Bolpoin/Pensil
	...
	<div class="pull-left">
			...
			<?php	
			 ...
			 <?php	
	           $count_item=mysql_query("select * from stdevice 
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_status = 'rusak' and dev_name = 'AmPlOp' OR dev_status = 'rusak' and dev_name = 'Amplop'
