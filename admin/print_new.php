  ...
  <div class="row-fluid">
      <div class="col-lg-12">
            <div class="alert alert-success alert-dismissable">
             ...
             <i class="icon-check"></i><strong> Cetak Laporan Barang Baru</strong>
            </div>
       </div>
    </div>
  </div>
...
<p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
text-align:center;line-height:normal'><b><span style='font-size:14.0pt;
font-family:"Times New Roman","serif"'>Laporan Barang Masuk</span></b></p>
...
"Times New Roman","serif"'>Barang Masuk Baru<o:p></o:p></span></p>
...
<div class="pull-right">
   <div class="empty">
		   ...
		   <script type="text/javascript">
            ...
            normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
           "Times New Roman","serif"'>
			<a id="return" data-placement="top" class="btn btn-success" title="Click to Return" href="newdevice.php"><i class="icon-arrow-left"></i> Kembali</a></p>		
			<script type="text/javascript">
			$(document).ready(function(){
			$('#return').tooltip('show');
			$('#return').tooltip('hide');
...
<?php
	   ...
	   (select * from location_details where stdevice.id = location_details.id)
		and dev_status='Baru' ORDER BY stdevice.id DESC")or die(mysql_error());
