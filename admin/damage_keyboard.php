      ...
      ORDER BY stdevice.id DESC");
       ...
       <div id="block_bg" class="block">
                    <div class="navbar navbar-inner block-header">
                         <div class="muted pull-left"><i class="icon-reorder icon-large"></i>Daftar Pengeluaran Dianix</div>
...
<div class="row-fluid">
 <div class="empty">
   ...
   <a href="lapker.php" class="btn btn-info" id="print" data-placement="left" title="Klik untuk Print"><i class="icon-print icon-large"></i> Cetak</a>
   <script type="text/javascript">
     $(document).ready(function(){
     $('#print').tooltip('show');
     $('#print').tooltip('hide');
...
$('#btn-filter').click(function(e) {
  ...
  $.ajax({
    method: "post",
    url: "filter_barang_keluar_dianix.php",
