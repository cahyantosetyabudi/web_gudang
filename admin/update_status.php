		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div id="" class="block">
		                            <div class="navbar navbar-inner block-header">
										...
										<div class="muted pull-right"><a id="return" data-placement="left" title="Click to Return" href="Newdevice.php"><i class="icon-arrow-left"></i> Kembali</a>
										</div>
								    ...
								    <div class="container-fluid">
                                     ...
                                     <strong>Note!</strong> Perbarui Status barang tidak ditampilkan dalam daftar barang Baru.
                                     </div>
									 </div>
									 </div>
