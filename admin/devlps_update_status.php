	                        ...
	                        ?>	
		                        ...
		                        <div id="" class="block">
		                            <div class="navbar navbar-inner block-header">
		                                <div class="muted pull-left"><i class="icon-building"></i> Lokasi:&nbsp;<?php echo $location_row['stdev_location_name']; ?> Update Status Barang</div>
										<div class="muted pull-right">
										<a id="return" data-placement="left" title="Click to Return" href="mypower_supply.php<?php echo '?stdev_id='.$stdev_id; ?>"><i class="icon-arrow-left"></i> Kembali</a>
										</div>
