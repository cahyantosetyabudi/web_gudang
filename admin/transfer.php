				...
				<?php include('device_location_slidebar.php'); ?>
						...
						<div class="span9" id="content">
                          ...
                          <div class="empty">
                              ...
                              <strong>Kami akan mengarahkan kembali ke lokasi yang Anda pilih</strong>
                            </div>
			               </div>
	                        ...
	                        ?>	
		                        ...
		                        <div id="" class="block">
		                            <div class="navbar navbar-inner block-header">
		                                <div class="muted pull-left">Dari:&nbsp;<?php echo $location_row['stdev_location_name']; ?>Transfer Barang</div>
										<div class="muted pull-right">
										<a id="return" data-placement="left" title="Click to Return" href="mydevice.php<?php echo '?stdev_id='.$stdev_id; ?>"><i class="icon-arrow-left"></i> Kembali</a>
										</div>
									...
									?>
									 ...
									 <form class="form-horizontal" method="post">
									   ...
									   <div class="control-group">
										...
										<div class="control-group">
		                                  <label class="control-label" for="inputEmail">Pindah Ke</label>
			                                <div class="controls">
										...
										<button id="move" data-placement="right" title="Click to Move Device" name="transfer" type="submit" class="btn btn-warning"><i class="icon-move"></i> Pindah</button>
										</div>
										</div>
										<script type="text/javascript">
										$(document).ready(function(){
