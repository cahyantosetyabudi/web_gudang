            ...
            <div class="navbar-inner">
               <div class="container-fluid">
				 ...
				 <div class="navbar-header">
                    ...
                    <span class="brand" href="#">Sistem Informasi Persediaan Barang CV SURITEX</span>
				 </div>
				  <!--.nav-collapse -->
						...
						?>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                       <a tabindex="-1" href="change_password_admin.php"><i class="icon-cog"></i>&nbsp;Ubah Password</a>
