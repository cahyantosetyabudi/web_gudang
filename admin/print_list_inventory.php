  ...
  <div class="row-fluid">
      <div class="col-lg-12">
            <div class="alert alert-success alert-dismissable">
             ...
             <i class="icon-building"></i><strong>&nbsp;<?php echo $location_row['stdev_location_name']; ?>&nbsp;Cetak Laporan</strong>
            </div>
       </div>
    </div>
  </div>
...
src="print-list-inventory_files/sclogo.png"></span></b></p>
...
<div class="pull-right">
   <div class="empty">
		   ...
		   <script type="text/javascript">
            ...
            normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
           "Times New Roman","serif"'>
			<a id="return" data-placement="top" class="btn btn-success" title="Click to Return" href="mydevice.php<?php echo '?stdev_id='.$get_id; ?>"><i class="icon-arrow-left"></i> Kembali</a></p>		
			<script type="text/javascript">
			$(document).ready(function(){
			$('#return').tooltip('show');
			$('#return').tooltip('hide');
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:23.25pt'>
  ...
  191;padding:0in 5.4pt 0in 5.4pt;height:23.25pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Tanggal Ditetapkan<o:p></o:p></span></b></p>
  </td>
  <td width=188 style='width:140.95pt;border:solid windowtext 1.0pt;border-left:
  none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:#BFBFBF;mso-background-themecolor:background1;mso-background-themeshade:
 ...
 <tr style='mso-yfti-irow:2'>
  ...
  <?php	
             ...
             (select * from location_details where dev_status='Dump')
			  ...
			  OR NOT EXISTS 
             (select * from location_details where dev_status='Dump')
			  and dev_name = 'krs'  and stdev_id = '$get_id' 
			  OR NOT EXISTS 
             (select * from location_details where dev_status='Dump')
			  and dev_name = 'kerta'    and stdev_id = '$get_id' ")or die(mysql_error());
...
LEFT JOIN stdevice ON location_details.id = stdevice.id 
LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
where dev_status = 'Baru' and stdev_id = '$get_id'		
order by date_deployment DESC")or die(mysql_error());
...
?>
  ...
  <?php	
				...
				OR NOT EXISTS 
                (select * from location_details where dev_status='Dump')
				and dev_name = 'ipex' and stdev_id = '$get_id' ")or die(mysql_error());
...
LEFT JOIN stdevice ON location_details.id = stdevice.id 
LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
where dev_status = 'Terpakai' and stdev_id = '$get_id'		
order by date_deployment DESC")or die(mysql_error());
$count = mysql_num_rows($new);		                                               
?>   
  <td width=171 valign=top style='width:128.35pt;border-top:none;border-left:
  ...
  <?php	
				...
				OR NOT EXISTS 
                (select * from location_details where dev_status='Dump')
				and dev_name = 'bkukwin'     and stdev_id = '$get_id'
				OR NOT EXISTS 
                (select * from location_details where dev_status='Dump')
				and dev_name = 'bukkwtns'     and stdev_id = '$get_id' 
				OR NOT EXISTS 
                (select * from location_details where dev_status='Dump')
				and dev_name = 'bkukwtns'      and stdev_id = '$get_id'
				OR NOT EXISTS 
                (select * from location_details where dev_status='Dump')
				...
				OR NOT EXISTS 
                (select * from location_details where dev_status='Dump')
				and dev_name = 'kwtns'   and stdev_id = '$get_id' 
				OR NOT EXISTS 
                (select * from location_details where dev_status='Dump')
				and dev_name = 'buku'      and stdev_id = '$get_id'
				OR NOT EXISTS 
                (select * from location_details where dev_status='Dump')
			    and dev_name = 'buk' and stdev_id = '$get_id' 
				OR NOT EXISTS 
                (select * from location_details where dev_status='Dump')
				and dev_name = 'bku'   and stdev_id = '$get_id' ")or die(mysql_error());
...
LEFT JOIN stdevice ON location_details.id = stdevice.id 
LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
where dev_status = 'Diperbaiki' and stdev_id = '$get_id'		
order by date_deployment DESC")or die(mysql_error());
$count = mysql_num_rows($new);		                                               
?>
 ...
 <?php	
				...
				OR NOT EXISTS 
                (select * from location_details where dev_status='Dump')
				and dev_name = 'bkutlis'   and stdev_id = '$get_id'
				OR NOT EXISTS 
                (select * from location_details where dev_status='Dump')
				and dev_name = 'bkutul'      and stdev_id = '$get_id' 
				OR NOT EXISTS 
                (select * from location_details where dev_status='Dump')
				...
				OR NOT EXISTS 
                (select * from location_details where dev_status='Dump')
				and dev_name = 'bkutulis'               and stdev_id = '$get_id' 
				OR NOT EXISTS 
                (select * from location_details where dev_status='Dump')
...
LEFT JOIN stdevice ON location_details.id = stdevice.id 
LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
where dev_status = 'rusak' and stdev_id = '$get_id'		
order by date_deployment DESC")or die(mysql_error());
$count = mysql_num_rows($new);		                                               
?>
  ...
  <?php	
				...
				OR NOT EXISTS 
                (select * from location_details where dev_status='Dump')
			    and dev_name = 'gtng'      and stdev_id = '$get_id' 
				OR NOT EXISTS 
                (select * from location_details where dev_status='Dump')
