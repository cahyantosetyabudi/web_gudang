<?php
  ...
  $bulan = $_POST['bulan'];
  $tahun = $_POST['tahun'];
  $sql = mysql_query("select * from stdevice LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id WHERE dev_tanggal BETWEEN ".$tahun.$bulan."01 AND ".$tahun.$bulan."31");
