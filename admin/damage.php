     ...
     where dev_status = 'Terpakai' OR dev_status = 'terpakai' ORDER BY stdevice.id DESC");
       ...
       <div id="block_bg" class="block">
                    <div class="navbar navbar-inner block-header">
                         <div class="muted pull-left"><i class="icon-reorder icon-large"></i> Daftar Kerusakan Persediaan Barang</div>
    ...
    <li class="">
     ...
     ORDER BY stdevice.id DESC");
         $count = mysql_num_rows($count_item);
           ?>
    <li class="">
    <a href="damage_monitor.php">Dyeing&nbsp;<span class="label label-default"> <?php echo $count;?></span></a></a></a>
    </li>
...
<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
  ...
  <tbody id="table-body">
    <?php
      $sql = mysql_query("select * from stdevice
                 ...
                 LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
                 where dev_status = 'terpakai' ORDER BY location_details.ld_id DESC");
...
$('#btn-filter').click(function(e) {
  ...
  $.ajax({
    method: "post",
    url: "filter_barang_keluar_semua.php",
