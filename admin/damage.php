                 ...
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-remove-sign"></i> Daftar Kerusakan Persediaan Barang</div>
                          <div class="muted pull-right">
								Jumlah Barang: <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
						  </div>
						  
				<h4 id="sc">Daftar Pengeluaran Persediaan Barang
 ...
 <div class="container-fluid">
   ...
   <div class="empty">
	   <div class="pull-right">
	     <a href="print_damage.php" class="btn btn-info" id="print" data-placement="left" title="Klik untuk Cetak"><i class="icon-print icon-large"></i> Cetak</a> 	 
