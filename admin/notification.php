                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
							 <div class="muted pull-left"><i class="icon-globe"></i> Notifikasi</div>                               
                            </div>
...
<form action="read.php" method="post">
					...
					<div class="post"  id="del<?php echo $id; ?>">
							...
							<hr>										
										...
										<div class="pull-right">
										<a class="btn btn-link"  href="#<?php echo $id; ?>" data-toggle="modal" ><i class="icon-trash"></i> Hapus </a>
									    </div>								
					...
					?>
					<div class="alert alert-info"><strong><i class="icon-info-sign"></i> Notifikasi Tidak Ditemukan</strong></div>
					<?php
					}
					?>
