                 ...
                 ?>
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-user"></i> Aktivitas Penggunaa Sistem</div>
								<div class="muted pull-right">
								Jumlah Aktivitas pengguna sistem: <span class="badge badge-info"><?php  echo $count; ?></span>
								</div>
                            </div>
