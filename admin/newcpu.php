                 ...
                 ?>	
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-check"></i>&nbsp;Daftar Baru Amplop kabinet Cokelat</div>
							 <div class="muted pull-right">
								Jumlah Baru Amplop Kabinet Cokelat: <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                          </div>
						  
				<h4 id="sc">Daftar Baru Amplop Kabinet Cokelat
  ...
  <div class="row-fluid"> 
     <div class="empty">
	     <div class="pull-right">
		   <a href="printamplop.php" class="btn btn-info" id="print" data-placement="left" title="Klik untuk Print"><i class="icon-print icon-large"></i> Cetak</a> 		      
		   <script type="text/javascript">
		     $(document).ready(function(){
		     $('#print').tooltip('show');
		     $('#print').tooltip('hide');
