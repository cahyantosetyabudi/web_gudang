     <div class="span3" id="sidebar">
	              <div class="empty" >
				   <img id="admin_avatar" class="img-polaroid" src="<?php echo $row['adminthumbnails']; ?>"></div>
                    ...
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						...
						<li class="">						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs"><i class="icon-chevron-right"></i><i class="icon-tablet icon-large"></i>&nbsp;MengelolaPersediaan Barang
				 ...
				 <a href="dump_device.php"><i class="icon-chevron-right"></i><i class="icon-remove-sign"></i> Barang Keluar/Terpakai
