					  ...
					  <div class="alert alert-success"><i class="icon-info-sign"></i> Harap Isi detail yang dibutuhkan</div>
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><i class="icon-user"></i>&nbsp;Ubah Kata Sandi</div>							 
                            </div>
								 ...
								 <div class="container-fluid">
								    ...
								    <form  method="post" id="change_password" class="form-horizontal">
										<div class="control-group">
											<label class="control-label" for="inputEmail">kata sandi saat ini</label>
											<div class="controls">
										...
										<div class="control-group">
											<label class="control-label" for="inputPassword">Kata Sandi Baru</label>
											<div class="controls">
											<input type="password" id="new_password" name="new_password" placeholder="New Password">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="inputPassword">Ketik ulang kata sandi</label>
											<div class="controls">
