                 ...
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-remove-sign"></i> Daftar Pengeluaran Finishing</div>
                          <div class="muted pull-right">
								Jumlah Barang: <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
						  </div>
						  
				<h4 id="sc">Daftar Pengeluaran Finishing
  ...
  <div class="row-fluid"> 
     <div class="empty">
	     <div class="pull-right">
		   <a href="lapbuk.php" class="btn btn-info" id="print" data-placement="left" title="Klik untuk Print"><i class="icon-print icon-large"></i> Cetak</a> 		      
