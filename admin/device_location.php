                     ...
                     <div class="row-fluid">					 					 
                        ...
                        <div class="block">
								<div class="navbar navbar-inner block-header">
								    <div class="muted pull-left"><i class="icon-reorder icon-building"></i> Tampilan Daftar Lokasi</div>
									
						<div id="" class="muted pull-right">
								<?php 
								$my_location = mysql_query("select * from stlocation ")or die(mysql_error());
								$count_my_location = mysql_num_rows($my_location);?>
								Jumlah Daftar Lokasi: <span class="badge badge-info"><?php echo $count_my_location; ?></span>
						</div>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									<ul	 id="da-thumbs" class="da-thumbs">
										...
										<?php } }else{ ?>										
									     <div class="alert alert-info"><i class="icon-info-sign"></i> Tidak Ada Lokasi Yang Ditambahkan Saat Ini</div>
										<?php  } ?>
									</ul>
                                </div>
                            </div>
