...
<div class="modal-body">
    <form class="form-horizontal" method="post" action="advance_search.php">
			  ...
			  <option>&larr; Pilih Lokasi &rarr;</option>
			  <?php
			  ...
			  <option>&larr; Pilih Serial Barang &rarr;</option>
			  <?php
			  ...
			  <?php } ?>
                ...
                <div class="control-group">
                <div class="controls">
                <button type="submit" id="search" data-placement="left" title="Click to Search" class="btn btn-primary"><i class="icon-search"></i> Cari</button>
