        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
				 ...
				 where dev_status = 'rusak'    and dev_name = 'HEKTER' OR dev_status = 'rusak' and dev_name = 'Hekter' 
			OR dev_status = 'rusak'    and dev_name = 'hktr'  OR dev_status = 'rusak'     and dev_name = 'htr' 
		    OR dev_status = 'rusak'    and dev_name = 'ter'  OR dev_status = 'rusak'     and dev_name = 'hek' 
			...
			OR dev_status = 'rusak'    and dev_name = 'heetr'    OR dev_status = 'rusak'     and dev_name = 'hhektr' 
                 ...
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-remove-sign"></i> Daftar Kerusakan Hekter/Isi</div>
                          <div class="muted pull-right">
								Jumlah Barang: <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
						  </div>
						  
				<h4 id="sc">Daftar Kerusakan pada Hekter/Isi
	...
	<div class="pull-left">
			...
			<?php	
			 ...
			 <?php	
	           $count_item=mysql_query("select * from stdevice 
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			    where dev_status = 'rusak' and dev_name = 'amplp' OR dev_status = 'rusak' and dev_name = 'ammpl'
 ...
 <div class="container-fluid">
   ...
   <div class="empty">
	   <div class="pull-right">
	     <a href="#" onClick="window.print()" class="btn btn-info" id="print" data-placement="left" title="Klik untuk Cetak"><i class="icon-print icon-large"></i> Cetak </a> 
