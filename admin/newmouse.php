                 ...
                 ?>	 
				   ...
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-check"></i>&nbsp;Daftar Bolpoin/Pensil Baru</div>
							  <div class="muted pull-right">
								Jumlah Bolpoin/Pensil Baru: <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                          </div>
						  
				<h4 id="sc">Daftar Bolpoin/Pensil baru
