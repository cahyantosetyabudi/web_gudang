         ...
         ?>
				   ...
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-check"></i>&nbsp;Daftar Barang Masuk Finishing</div>
							 <div class="muted pull-right">
								Jumlah Barang Masuk Finishing: <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                          </div>

				<h4 id="sc">Daftar Barang Masuk Finishing
  ...
  <div class="row-fluid">
     <div class="empty">
	     <div class="pull-right">
		   <a href="printbuktul.php" class="btn btn-info" id="print" data-placement="left" title="Klik untuk Print"><i class="icon-print icon-large"></i> Cetak</a>
		   <script type="text/javascript">
		     $(document).ready(function(){
		     $('#print').tooltip('show');
		     $('#print').tooltip('hide');
...
<!-----------------------------------Content------------------------------------>
		...
		<?php
	    $device_query = mysql_query("select * from stdevice LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id where device_name.dev_name = 'Finishing' ORDER BY stdevice.id DESC") or die(mysql_error());
...
<script type="text/javascript">
  $(document).ready(function() {
    $('#btn-filter').click(function(e) {
      ...
      $.ajax({
        method: "post",
        url: "filter_barang_finishing.php",
        data: $('#send').serialize(),
