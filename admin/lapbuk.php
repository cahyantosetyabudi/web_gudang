...
"Times New Roman","serif"'>Bagian Finishing<o:p></o:p></span></p>
...
<div class="pull-right">
   <div class="empty">
		   ...
		   <script type="text/javascript">
            ...
            normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
           "Times New Roman","serif"'>
			<a id="return" data-placement="top" class="btn btn-success" title="Click to Return" href="damage_vga.php"><i class="icon-arrow-left"></i> Kembali</a></p>		
			<script type="text/javascript">
			$(document).ready(function(){
			$('#return').tooltip('show');
			$('#return').tooltip('hide');
...
<?php
		$device_query = mysql_query("select * from stdevice			
							 ...
							 where dev_name = 'Finishing' And dev_status = 'Terpakai' ORDER BY location_details.ld_id DESC")or die(mysql_error());
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:1'>
  ...
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-size:12.0pt;
  mso-bidi-font-size:11.0pt;font-family:"Times New Roman","serif"'>Tipe Barang<o:p></o:p></span></b></p>
  </td>
 ...
 <?php	
			...
			where NOT EXISTS 
	           ...
	           and dev_status = 'Terpakai' and dev_name = 'Finishing'
		       OR NOT EXISTS 
	           (select * from location_details where stdevice.id = location_details.id)
		       and dev_status = 'Terpakai' and dev_name = 'FINISHING'
		       OR NOT EXISTS 
		       ...
		       OR NOT EXISTS 
	          (select * from location_details where stdevice.id = location_details.id)
		       and dev_status = 'Terpakai' and dev_name = 'fnishing'
		      OR NOT EXISTS 
	          (select * from location_details where stdevice.id = location_details.id)
		       and dev_status = 'Terpakai' and dev_name = 'fnis'
		      OR NOT EXISTS 
	          (select * from location_details where stdevice.id = location_details.id)
		       and dev_status = 'Terpakai' and dev_name = 'finish'
		       OR NOT EXISTS 
	          (select * from location_details where stdevice.id = location_details.id)
		       and dev_status = 'Terpakai' and dev_name = 'finis'
		       OR NOT EXISTS 
	           (select * from location_details where stdevice.id = location_details.id)
		       and dev_status = 'Terpakai' and dev_name = 'finis'
		       OR NOT EXISTS 
		      ...
		      OR NOT EXISTS 
	          (select * from location_details where stdevice.id = location_details.id)
		      and dev_status = 'Terpakai' and dev_name = 'fns'
		      OR NOT EXISTS 
	          (select * from location_details where stdevice.id = location_details.id)
		      and dev_status = 'Terpakai' and dev_name = 'fns'
 ...
 ?>		
  ...
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
  "Times New Roman","serif"'>Finishing<o:p></o:p></span></p>
  </td>
...
<?php	
	             $count_item=mysql_query("select * from stdevice 
				 LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
				 where dev_name = 'Finishing' And dev_status = 'Terpakai' ORDER BY stdevice.id DESC ");
	             $count = mysql_num_rows($count_item);
 ?>	 
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:44.85pt'>
  ...
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
  "Times New Roman","serif"'>Dibuat Oleh:<o:p></o:p></span></p>
  </td>
...
?>
 ...
 <tr style='mso-yfti-irow:2;mso-yfti-lastrow:yes'>
  ...
  mso-bidi-font-size:11.0pt;font-family:"Times New Roman","serif"'>Administrasi<o:p></o:p></span></p>
  </td>
  </td>
 </tr>
</table>
