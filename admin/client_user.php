                 ...
                 ?>	 
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-user"></i> Daftar Technical Staff User</div>
								<div class="muted pull-right">
								Jumlah Client user: <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                            </div>
                            <div class="block-content collapse in">
								...
								<form action="delete_client.php" method="post">
									...
									<a data-placement="right" title="klik untuk hapus item"  data-toggle="modal" href="#client_delete" id="delete"  class="btn btn-danger" name=""><i class="icon-trash icon-large"> Hapus</i></a>
