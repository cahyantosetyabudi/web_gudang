            ...
            <div class="row-fluid">
				<?php include('Device_sidebar.php'); ?>
		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div class="block">
		                            <div class="navbar navbar-inner block-header">
										...
										<div class="muted pull-right"><a id="return" data-placement="left" title="Klik untuk kembali" href="device_stocks.php"><i class="icon-arrow-left icon-large"></i> Kembali</a></div>
		                ...
		                <div class="block-content collapse in">	
                         <div class="alert alert-success"><i class="icon-info-sign"></i> Harap Isi detail yang dibutuhkan</div>						
...
mysql_query("insert into stdevice (dev_tanggal,dev_id,dev_faktur,dev_desc,dev_serial,dev_brand,dev_model,dev_qty,dev_status) values('$dev_tanggal','$dev_id','$dev_faktur','$dev_desc','$dev_serial','$dev_brand','$dev_model','$dev_qty','$dev_status')")or die(mysql_error());
