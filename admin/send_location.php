   <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Tambah System User</div>
                            </div>
                     ...
                     <form method="post" action="send.php">
                          <div class="span12">
							...
							<div class="control-group">
								    ...
								    <button name="delete_sudent" class="btn btn-primary"><i class="icon-plus-sign icon-large"></i> Kirim Lokasi</button>
					                  </div>
				                     </div>
                                </div>
                              </form>
