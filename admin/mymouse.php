        ...
        <!-------------------------------block ------------------------------>
			...
			<?php 
               ...
               (select * from location_details where dev_status='Dump')
				...
				Daftar Bolpoin/Pensil: <span class="badge badge-info"><?php echo $count_my_device; ?></span>
			</div>
								
       </div>
							
<!-----------------------------------for Print display visible------------------------------------>	
<h4 id="sc">Lokasi:<?php echo $location_row['stdev_location_name']; ?> Daftar Bolpoin/Pensil
