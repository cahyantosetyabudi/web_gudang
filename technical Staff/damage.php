        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
				 ...
				 where dev_status = 'rusak' OR dev_status = 'Rusak' ORDER BY stdevice.id DESC ");
...
<?php
		$device_query = mysql_query("select * from stdevice			
							 ...
							 LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
							 where dev_status = 'rusak' ORDER BY location_details.ld_id DESC")or die(mysql_error());
		...
		<td class="empty">
			...
			<td><a rel="tooltip" title="Repair" id="e<?php echo $id; ?>" href="#repair<?php echo $id; ?>" data-toggle="modal" class="btn btn-success"><div class="hide">Rusak</div>Repair</a></td>
			<?php }else{ ?>			
			<?php } ?>
